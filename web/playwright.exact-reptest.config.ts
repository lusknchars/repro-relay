...
export default defineConfig({
  ...
  webServer: [
    ...
    {command:'node ../scripts/start-reptest-api.mjs',url:'http://127.0.0.1:8182/api/v1/health',timeout:30_000,env:{REPRO_PORT:'8182',DATABASE_URL:process.env.E2E_DATABASE_URL||'postgres://relay:relay_local_only@127.0.0.1:55478/relay_e2e',REPRO_HERMES_URL:'http://127.0.0.1:8654',REPRO_HERMES_KEY:'browser-fixture-key'}},
