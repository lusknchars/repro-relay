    ...
    <div className="context-columns">
      <section className="context-evidence" aria-label="Role context">
        ...
        {loading ? <p role="status">Preparing context…</p> : context && <>
          ...
          <div className="context-unknowns"><Fingerprint size={17}/><div><strong>Still needed before an agent can repair</strong><p>A repository, a base commit, and an executable acceptance check. No agent has been started.</p></div></div>
