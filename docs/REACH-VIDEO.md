...
Validation on September 15, 2026: `make check` passed in the isolated feature checkout. The merged workspace also passed the video browser test. The macOS debug bundle built successfully, includes camera/microphone usage descriptions and the Daily SDK license, and was reopened. The live local backend exposes the meeting endpoints with Daily unconfigured and Hermes available. No live Daily room, media session or transcription was exercised.
